			...
			<div class='card'>
				...
				<div class='card-body'>
					...
					<form method="post" action="ExecuteInsertBigliettoServlet"
						...
						<c:set var="biglietto" value="${visualizza_biglietto_attr}"/>
						

						<div class="col-md-6">
							<label for="codice" class="form-label">Destinazione <span
								class="text-danger">*</span></label> <input type="text" name="destinazione"
								id="codice" class="form-control"
						...
						<div class="col-md-6">
							<label for="codice" class="form-label">Provenienza <span
								class="text-danger">*</span></label> <input type="text" name="provenienza"
								id="codice" class="form-control"
						...
						<div class="col-md-6">
							<label for="prezzo" class="form-label">Prezzo <span
								...
								value="<%=bigliettoInPagina.getPrezzo()<1?bigliettoInPagina.getPrezzo():"" %>"
								required>
						</div>

						<div class="col-md-3">
							<label for="data" class="form-label">Data<span class="text-danger">*</span>
							</label> <input class="form-control" name="data" id="data"
